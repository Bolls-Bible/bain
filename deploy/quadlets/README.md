...
- `bolls-db.container` is capped at 2 GB, with PostgreSQL memory tuned around a 512 MB `shared_buffers` target and a 2 GB `/dev/shm` budget for large index builds.
