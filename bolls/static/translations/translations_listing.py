...
languages = [
	...
	},
	{
		...
		"translations": [
			{
				"short_name": "ARA",
				"full_name": "Almeida Revista e Atualizada, 1959",
...
for language in languages:
	for translation in language["translations"]:
		...
		translations_list += '* ' + translation["short_name"] + ', ' + translation["full_name"] + '\n'
# print(translations_list, len(translations))


# # Code that updates all translations
# for translation in translations:
# 	# fetchtranslation
# 	# save translation
# 	url = 'https://bolls.life/get-translation/' + translation["short_name"]

# 	response = requests.get(url)

# 	translation_filename = translation["short_name"] + '.json'
