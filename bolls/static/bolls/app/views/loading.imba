export tag loading-animation
	...
	def render
		<self>
			<div[transform: scale({scale(2400)}) translateX({translateX(2400)}px) translateY({translateY(2400)}px)]>
				<svg[transform: rotateY({rotate(2400)}deg)]
			...
			<div[transform: scale({scale(2100)}) translateX({translateX(2100)}px) translateY({translateY(2100)}px)]>
				<svg[transform: rotateY({rotate(2100)}deg)]
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
					>
					<title> "loading animation"
					<path d="M0 0l20 8-8 4-2 8z">
			<div[transform: scale({scale(1800)}) translateX({translateX(1800)}px) translateY({translateY(1800)}px)]>
				<svg[transform: rotateY({rotate(1800)}deg)]
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
					>
					<title> "loading animation"
			...
			<div[transform: scale({scale(1500)}) translateX({translateX(1500)}px) translateY({translateY(1500)}px)]>
				<svg[transform: rotateY({rotate(1500)}deg)]
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
					>
					<title> "loading animation"
					<path d="M8.4 12H2.8L1 15H0V5h1l1.8 3h5.6L6 0h2l4.8 8H18a2 2 0 1 1 0 4h-5.2L8 20H6l2.4-8z">
			<div[transform: scale({scale(1200)}) translateX({translateX(1200)}px) translateY({translateY(1200)}px)]>
				<svg[transform: rotateY({rotate(1200)}deg)]
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
					>
					<title> "loading animation"
			...
			<div[transform: scale({scale(900)}) translateX({translateX(900)}px) translateY({translateY(900)}px)]>
				<svg[transform: rotateY({rotate(900)}deg)]
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
					>
					<title> "loading animation"
					<path d="M20.5 6c-2.61.7-5.67 1-8.5 1s-5.89-.3-8.5-1L3 8c1.86.5 4 .83 6 1v13h2v-6h2v6h2V9c2-.17 4.14-.5 6-1l-.5-2zM12 6c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z">
			<div[transform: scale({scale(600)}) translateX({translateX(600)}px) translateY({translateY(600)}px)]>
				<svg[transform: rotateY({rotate(600)}deg)]
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 24 24"
					>
					<title> "loading animation"
			...
			<div[transform: scale({scale(300)}) translateX({translateX(300)}px) translateY({translateY(300)}px)]>
				<svg[transform: rotateY({rotate(300)}deg)]
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 20 20"
					>
					<title> "loading animation"
			...
			<div[transform: scale({scale(0)}) translateX({translateX(0)}px) translateY({translateY(0)}px)]>
				<svg[transform: rotateY({rotate(0)}deg)]
						xmlns="http://www.w3.org/2000/svg"
